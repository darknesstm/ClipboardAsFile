...
- 右键点击托盘图标可显示菜单：
  ...
  - **关于**: 显示关于信息
  - **退出**: 退出应用程序
- 操作结果通过 Windows 右下角气泡通知显示，不会打断当前工作
...
### 通知系统
- 使用 Windows Shell 气泡通知（Balloon Notification）
- 通过 `Shell_NotifyIcon` 的 `NIM_MODIFY` 操作实现
- 支持信息、警告、错误三种图标类型
- 不会打断用户当前工作，非侵入式提示
